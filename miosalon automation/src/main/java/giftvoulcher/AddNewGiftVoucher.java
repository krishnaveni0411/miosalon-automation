...
// add new gift voucher without selecting the message template.
...
public static void main(String[] args) throws InterruptedException {
	...
	driver.findElement(By.xpath("(//input[@class='form-control ng-pristine ng-valid'])[3]")).sendKeys("new year voucher 23");
	...
	driver.findElement(By.xpath("//button[@title='Choose Tax Type']")).click();
	WebElement taxType=driver.findElement(By.xpath("//select[@title='Choose Tax Type']"));
	Select selectOptionsForTaxType=new Select(taxType);
	selectOptionsForTaxType.selectByVisibleText("Exclude");
